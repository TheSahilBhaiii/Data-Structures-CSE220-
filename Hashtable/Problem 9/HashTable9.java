...
The class should include a hash_function that calculates the hash index
by summing the ASCII values of the first two characters of the key.
If the key is only one character, the ASCII value of 'Z' (90) should be added
as the second character.

The insert() method should add a new key-value pair or update the value
if the key already exists. Use forward chaining to handle collisions.
...
class HashTable9 {
    ...
    private int hashFunction(String key) {
        ...
        return index; // remove after implementing
    }
